...
@patch('app.repositories.user_repo.DBUserI.del_user', return_value = True)
@patch('app.repositories.user_repo.DBUserI.get_user_by_public_id', return_value = user_mock1)
...
user_mock2 = None
@patch('app.repositories.user_repo.DBUserI.get_user_by_public_id', return_value = user_mock2)
