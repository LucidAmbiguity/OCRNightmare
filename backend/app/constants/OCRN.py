...
class OCRN:
    ...
    Pages = ApiResp('OCRN00010', 'List of pages')
    Page = ApiResp('OCRN00011', 'A page')
    PageWText =ApiResp('OCRN00012', 'A Page With Text')

    class Extract:
        ROOT =  ApiResp('OCRN0110', 'OCRN Project Extract Root')
